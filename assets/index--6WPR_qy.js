import{a as _,s as J,t as L,b as V,d as Z}from"./main-D5Bk27SH.js";import{s as M}from"./sfx-DMPbFRfs.js";import"./modulepreload-polyfill-B5Qt9EMX.js";const Y=[{id:"medical",emoji:"🚑",label:"EMERGENCY",priority:4,color:"#ff6b6b"},{id:"satellite",emoji:"🛰",label:"CRITICAL",priority:3,color:"#c9b6ff"},{id:"gifts",emoji:"🎁",label:"NORMAL",priority:2,color:"#ffd700"},{id:"pizza",emoji:"🍕",label:"LOW",priority:1,color:"#ff9944"}];let ee=0;function T(){return{...Y[Math.floor(Math.random()*Y.length)],uid:++ee}}function te(){if(document.getElementById("m3-styles"))return;const h=document.createElement("style");h.id="m3-styles",h.textContent=`
  ...
  `,document.head.appendChild(h)}function ne(h,X,z){te();const r=document.createElement("div");r.style.cssText=`position:fixed;inset:0;background:#05001a;z-index:10;
    font-family:'Space Mono',monospace,sans-serif;overflow:hidden;`,h.appendChild(r);const g=document.createElement("canvas");g.style.cssText="position:absolute;inset:0;pointer-events:none;",r.appendChild(g);function q(){const n=window.devicePixelRatio||1;g.width=r.clientWidth*n,g.height=r.clientHeight*n,g.style.width=r.clientWidth+"px",g.style.height=r.clientHeight+"px";const o=g.getContext("2d");o.setTransform(n,0,0,n,0,0),o.clearRect(0,0,r.clientWidth,r.clientHeight);for(let e=0;e<120;e++){const t=Math.random()*r.clientWidth,a=Math.random()*r.clientHeight,i=Math.random()*1.5+.3;o.beginPath(),o.arc(t,a,i,0,Math.PI*2),o.fillStyle=`rgba(255,255,255,${.3+Math.random()*.5})`,o.fill()}}q();let s=[],c=[],v=0,$=90,m=0,k=0,I=!1,b=8,C=null,f=null;const y=_(r,{color:"#c9b6ff"});y.leftEl.style.cursor="pointer",y.leftEl.title="Quit",y.leftEl.addEventListener("click",()=>R(!0));function N(){y.setLeft("◀ Back"),y.setCenter(`🚀 ${m}/10 &nbsp;|&nbsp; ✅ ${k} correct &nbsp;|&nbsp; ⭐ ${v}pts`),y.setRight(`⏱ ${$}s`)}const x=document.createElement("div");x.className="m3-col m3-col-left",r.appendChild(x);const u=document.createElement("div");u.className="m3-col m3-col-right",r.appendChild(u);const S=document.createElement("div");S.className="m3-pad",S.innerHTML=`
    ...
    <div style="font-size:10px;color:#8aa6b4;margin-top:4px;letter-spacing:1px;">
    ...
    </div>`,r.appendChild(S);function P(n,o,e){const t=document.createElement("div");t.className="m3-card",t.draggable=!0,t.style.cssText+=`background:${n.color}22;border-color:${n.color}55;`,t.innerHTML=`
      ...
      animation:popIn 0.3s ease both;`,e.textContent=n,r.appendChild(e),setTimeout(()=>e.remove(),1800)}function O(n,o){const e=document.createElement("div");e.style.cssText=`position:absolute;bottom:145px;left:50%;transform:translateX(-50%);
